// Validation functions for offer management
export const validateOfferForm = (offerName, offerValue, offerExpairyDate) => {
    const errors = {};
    ...
    if (!offerName) {
        ...
        errors.offerName = "Offer name can only contain uppercase letters spaces";
    }
