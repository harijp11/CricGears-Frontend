...
function AddCoupon() {
    ...
    const handleSubmit = async (e) => {
        ...
        const validationResult = validateCouponForm({
            code,
            description,
            discountValue,
            minPurchaseAmount,
        ...
        // Fix: Access the errors property from the validation result
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center p-4">
            {/* Fix: Changed class to className and fixed positioning */}
