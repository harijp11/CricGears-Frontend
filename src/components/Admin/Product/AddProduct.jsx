...
export default function AddProduct(){
    ...
    useEffect(()=>{
        async function fetchCat(){
             try{
                const response = await axiosInstance.get("/admin/sendCategory")
  ...
  const onCropComplete = useCallback((index)=>
    (croppedArea,croppedPixel)=>{
    ...
    // 
        ...
        //  console.log( uploadedImageUrls);
         ...
         toast.success("Product Added Successfully")
          setTimeout(()=>{navigate("/admin/viewproducts")},1000)
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        <div className="mb-8">
          ...
          <div>
              ...
              <button className="text-gray-500" onClick={()=>navigate("/admin/viewproducts")}>View Products &gt;</button>
              <button className="text-gray-500" onClick={()=>navigate("/admin/addProduct")}>Add Products </button>
              </div>
              <br/>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                 ...
                 onChange={(e)=>setPrice(e.target.value)}/> <span className="text-red-700  mt-10 ms-2">
                 {error && error.price}
               </span>
